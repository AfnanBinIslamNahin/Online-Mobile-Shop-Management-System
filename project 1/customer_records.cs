...
namespace project_1
{
    public partial class customer_records : Form
    {
        ...
        {
            InitializeComponent();
            showcustomer_records();
            ConfigureDataGridView();
        }

        private void showcustomer_records()
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("select * from payment", connection);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("select * from payment where payment_id = @payment_id", connection);
            cmd.Parameters.AddWithValue("@payment_id", payment_id.Text);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                payment_id.Text = row.Cells["payment_id"].Value.ToString();
